package com.example.kicktheworld_test.Trip.Controller;

import com.example.kicktheworld_test.Trip.Dto.MainItemDto;
import com.example.kicktheworld_test.Trip.Dto.TripDto;
...
//    }
    ...
    public String tripManage(TripSearchDto tripSearchDto, @PathVariable("page" ) Optional< Integer > page, Model model) {
        ...
        Page<Trip> trips = tripService.getMainTripPage(tripSearchDto, pageable);
        model.addAttribute("trips", trips);
        model.addAttribute("tripSearchDto", tripSearchDto);
        model.addAttribute("maxPage", 5);
        return "trip/tripPage";
